define(["appStorage", "browser"], function (appStorage, browser) {
    ...
    function getCapabilities() {
        var caps = {
            ...
            SupportsPersistentIdentifier: !1,
